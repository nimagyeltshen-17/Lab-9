...
public class Undirectedgraph {
    ...
    private static void DisplayGraph(Undirected graph) {
        int src = 0;
    ...
    public static void main(String[] args) {
        ...
        List<Edge> edges = Arrays.asList(new Edge(1, 2, 3), new Edge(4, 5, 6), new Edge(1, 3, 4), new Edge(2, 4, 5),
                new Edge(4, 2, 10), new Edge(2, 3, 4), new Edge(3, 1, 2));

        // construct graph from given list of edges
        Undirected graph = new Undirected(edges);
